...
echo
echo $green"=========================================="
echo $red"DoS AND DDoS ATTACK LAUCH VIA TOOL •⊱•Rafi"
echo $green"=========================================="
echo $red"===    ===    ===    ===   ===    ===   ==="
echo $white"===    ===    ===    ===   ===    ===   ==="
            echo $red"        ____...------------...____"
            echo $red"   _:-:: /o/ ---------------- \o\_ :-:_" 
            echo $green" .:     / / •⊱•SHEIKH RAFI SY\ \     :."
            echo $red" |=====/o/======================\o\=====|" 
            echo $red" |____/_/________..____..________\_\____|" 
            echo $red" :   _/ \_     :_oβ:__:βo_:     _/ \_   :" 
            echo $green" \__/_____\####/•⊱•use at own risk/####/__\__/"
            echo $yellow"  |===\!/========================\!/===|"
            echo $red"  |   |=|          .---.         |=|   |" 
            echo $red"  |===|o|=========/     \========|o|===|  " 
            echo $red"  |   | |         \() ()/        | |   |  " 
...
echo $white"                  MENU                     "
echo $green"============================================="
echo $red"[1].DDOS ATTACK.   #•⊱•RAFI#
echo $red"[2].DoS ATTACK.    #Rafi"
echo $red"[3].BOTNET ATTACK. #•⊱•RAFI"
echo $red"[4].EXIT TOOL.     #    Rafi"
echo $green"============================================="
echo $white "╭─"$yellow"•⊱•SHEIKHRAFI"
read -p " ╰─> " pil
...
echo $yellow"[5].LORIS"
echo $green"============================================="
echo $white "╭─"$yellow"•⊱•SheikhRafisystem"
read -p " ╰─> " ddos
fi
